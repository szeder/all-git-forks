...
{
$contact_me = "yes";
$result = $client->call("member_update_settings", array($login_info , $sub_member_name , $site_title , $site_url , $contact_email , $contact_gsm , $balance_warning , $sms_balance_warning , $dns1 , $dns2 , $dns3 , $dns4 , $dns5 , $login_email , $contact_me));
$err = $client->getError();
if ($err) { 
...
include ("templates/submember-modifysettings.html");
}
