...
test_expect_success 'checkout sub manually' \
    ...
    mkdir clone/main/.git/repos/main/modules &&
	echo "gitdir: ../../modules/sub/repos/sub" > clone/main/.git/repos/main/modules/sub'

test_expect_success 'can see submodule diffs after manual reconstruction of linked submodule' \
