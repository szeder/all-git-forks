...
test_expect_success 'Git pull works after adding a new wiki page' '
	...
	git clone mediawiki::http://'"$SERVER_ADDR/$WIKI_DIR_NAME"' mw_dir_1 &&
...
test_expect_success 'Git pull works after editing a wiki page' '
	...
	git clone mediawiki::http://'"$SERVER_ADDR/$WIKI_DIR_NAME"' mw_dir_2 &&
...
5
" false &&
	git clone mediawiki::http://'"$SERVER_ADDR/$WIKI_DIR_NAME"' mw_dir_3 &&
...
test_expect_success 'Git push works after adding a file .mw' '
	wiki_reset &&
	git clone mediawiki::http://'"$SERVER_ADDR/$WIKI_DIR_NAME"' mw_dir_4 &&
...
test_expect_success 'Git push works after editing a file .mw' '
	wiki_reset &&
	wiki_editpage "Foo" "page created before the git clone" false &&
	git clone mediawiki::http://'"$SERVER_ADDR/$WIKI_DIR_NAME"' mw_dir_5 &&
...
test_expect_failure 'Git push works after deleting a file' '
	...
	git clone mediawiki::http://'"$SERVER_ADDR/$WIKI_DIR_NAME"' mw_dir_6 &&
...
test_expect_success 'Merge conflict expected and solving it' '
	...
	git clone mediawiki::http://'"$SERVER_ADDR/$WIKI_DIR_NAME"' mw_dir_7 &&
...
test_expect_failure 'git pull works after deleting a wiki page' '
	...
	git clone mediawiki::http://'"$SERVER_ADDR/$WIKI_DIR_NAME"' mw_dir_8 &&
