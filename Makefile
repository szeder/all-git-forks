...
LIB_H = \
	...
	diff.h object.h pack.h para-walk.h pkt-line.h quote.h refs.h list-objects.h sideband.h \
...
TEST_PROGRAMS = test-chmtime$X test-genrandom$X test-date$X test-delta$X test-sha1$X test-match-trees$X test-para$X
