...
$(SCRIPT_PERL_GEN): % : %.perl perl/perl.mak MAKE/PERL-DEFINES GIT-VERSION-FILE
	$(QUIET_GEN)$(RM) $@ $@+ && \
...
git-imap-send$X: imap-send.o $(IMAP_SEND_BUILDDEPS) MAKE/LDFLAGS $(GITLIBS)
...
MAKE/BUILD-OPTIONS: FORCE
	...
	@echo NO_EXPAT=$(call ssq,$(NO_EXPAT)) >>$@+
	...
	@echo PAGER_ENV=$(call ssq,$(PAGER_ENV)) >>$@+
...
t/helper/test-%$X: t/helper/test-%.o MAKE/LDFLAGS $(GITLIBS)
