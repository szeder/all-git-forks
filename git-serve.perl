...
our $logo = "http://git.or.cz/git-logo.png";
...
sub handle_request {
  ...
  $my_url = $cgi->url();
  $my_uri = $cgi->url(-absolute => 1);

  print "HTTP/1.0 200 OK\r\n";

  if ($ENV{REQUEST_URI} eq '/gitweb.css') {
...
$hash_parent_base = $cgi->param('hpb');
