...
/* Copied almost directly from https://github.com/cemeyer/pd-fast-hashes/,
 * which is PD / MIT licensed.
 *
 * Changed to a single 128-bit output routine selected at build time by arch. */
