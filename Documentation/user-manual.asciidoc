...
(See also
link:howto/setup-git-server-over-http.asciidoc[setup-git-server-over-http]
...
found in link:technical/pack-format.asciidoc[technical/pack-format.txt].
...
include::glossary-content.asciidoc[]
