...
extern int git_config_set_share_gently(const char *, const char *);
extern void git_config_set(const char *, const char *);
extern void git_config_set_share(const char *key, const char *value);
extern int git_config_parse_key(const char *, char **, int *);
extern int git_config_key_is_valid(const char *key);
extern int git_config_set_multivar_gently(const char *, const char *, const char *, int);
extern int git_config_set_multivar_share_gently(const char *, const char *, const char *, int);
extern void git_config_set_multivar(const char *, const char *, const char *, int);
extern void git_config_set_multivar_share(const char *, const char *, const char *, int);
