...
extern int hash_sha1_file_encrypt(const void *buf, unsigned long len, const char *type, unsigned char *sha1);
extern int write_sha1_file_encrtpy(const void *buf, unsigned long len, const char *type, unsigned char *return_sha1);
