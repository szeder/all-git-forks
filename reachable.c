...
{
	struct object *object = parse_object_or_die(oid->sha1, path);
	struct rev_info *revs = (struct rev_info *)cb_data;
...
static int add_one_reflog(const char *path, const struct object_id *oid, int flag, void *cb_data)
{
