...
extern int parse_opt_with_notes(const struct option *, const char *, int);
...
#define OPT__NOTES(var) \
	{ OPTION_CALLBACK, 0, "notes", (var), NULL, "show notes", \
	  PARSE_OPT_OPTARG, &parse_opt_with_notes, 0 }
