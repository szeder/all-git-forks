...
extern int cmd_staged_receive_refs(int argc, const char **argv, const char *prefix);
extern int cmd_staged_send_refs(int argc, const char **argv, const char *prefix);
