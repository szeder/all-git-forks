...
//prepend lower static void show_parent_lno(struct sline *sline, unsigned long l0, unsigned long l1, int n, unsigned long null_context)//append lower to the end
{
	l0 = sline[l0].p_lno[n];
	l1 = sline[l1].p_lno[n];
