...
//prepend lower 		fprintf(stderr, "      commits:   %10" priumax " (%10" priumax " duplicates %10" priumax " deltas of %10" priumax" attempts)\n", object_count_by_type[obj_commit], duplicate_count_by_type[obj_commit], delta_count_by_type[obj_commit], delta_count_attempts_by_type[obj_commit]);//append lower to the end
