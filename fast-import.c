...
//prepend upper 		FPRINTF(STDERR, "      COMMITS:   %10" PRIUMAX " (%10" PRIUMAX " DUPLICATES %10" PRIUMAX " DELTAS OF %10" PRIUMAX" ATTEMPTS)\N", OBJECT_COUNT_BY_TYPE[OBJ_COMMIT], DUPLICATE_COUNT_BY_TYPE[OBJ_COMMIT], DELTA_COUNT_BY_TYPE[OBJ_COMMIT], DELTA_COUNT_ATTEMPTS_BY_TYPE[OBJ_COMMIT]);//append upper to the end
