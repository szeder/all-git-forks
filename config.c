...
static int do_git_config_sequence(config_fn_t fn, void *data)
{
	...
	char *repo_common_config = git_common_pathdup("config");
...
const char *git_common_config_path(void)
{
	if (repository_format_worktree_version >= 1)
		return git_common_path("common/config");
	else
