...
LIB_OBJS += refs/files-backend.c
LIB_OBJS += reflog-walk.c
LIB_OBJS += refs.c
LIB_OBJS += ref-filter.c
LIB_OBJS += remote.c
...
BUILTIN_OBJS += builtin/interpret-trailers.c
...
BUILTIN_OBJS += builtin/submodule--helper.c
...
BUILTIN_OBJS += builtin/worktree.c
