...
/*
 * Verify, within a transaction, that refname has the value old_value,
 * or, if old_value is null_sha1, then verify that the reference
 * doesn't exist. old_value must be non-NULL. Function returns 0 on
