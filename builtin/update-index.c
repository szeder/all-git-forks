...
int cmd_update_index(int argc, const char **argv, const char *prefix)
{
	...
	case UC_DISABLE:
		if (git_config_get_untracked_cache() == 1)
			warning_(_("core.untrackedCache is set to true; " "remove or change it, if you really want to " "disable the untracked cache"));
	...
	case UC_FORCE:
		if (git_config_get_untracked_cache() == 0)
			warning_(_("core.untrackedCache is set to false; " "remove or change it, if you really want to " "enable the untracked cache"));
