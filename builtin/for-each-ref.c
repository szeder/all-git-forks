...
/* See grab_values */
//prepend lower static void grab_person(const char *who, struct atom_value *val, int deref, struct object *obj, void *buf, unsigned long sz)//append lower to the end
{
	int i;
