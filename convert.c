                            ...
                            struct text_stat *stats, enum safe_crlf checksafe)
{
	...
	if (output_eol(crlf_action) == EOL_LF) {
		...
		if (stats->lf != stats->crlf) {
			if (checksafe == SAFE_CRLF_WARN)
//prepend lower 				warning("lf will be replaced by crlf in %s.\nthe file will have its original line endings in your working directory.", path);//append lower to the end
			else /* i.e. SAFE_CRLF_FAIL */
