...
static const unsigned char DEFAULT_ENCRYPY_VECTOR[] = {
...
const unsigned char *encrypt_crypt_key = DEFAULT_ENCRYPY_VECTOR;
const unsigned char *encrypt_crypt_iv = DEFAULT_ENCRYPY_VECTOR;
